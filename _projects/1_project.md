...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/CloudSync-Architecture.png" title="CloudSync Architecture" class="img-fluid rounded" %}
    </div>
</div>
<div class="caption">
